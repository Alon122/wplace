; (async () => {
  ...
  50% { text-shadow: 0 0 2px currentColor, 0 0 6px currentColor, 0 0 10px currentColor; }
}
...
#wplace-image-bot-container { left: 20px; z-index: 9998; }
#wplace-stats-container { left: 330px; z-index: 9997; }
...
.wplace-btn:hover::before { left: 100%; }
.wplace-btn:hover:not(:disabled) { transform: translateY(-2px); }
.wplace-btn:disabled {
  opacity: 0.4;
  cursor: not-allowed;
...
/* Button variants */
.wplace-btn-primary { background: #775ce3; color: #fff; }
.wplace-btn-stop { background: #e74c3c; color: #fff; }
.wplace-btn-start { background: #27ae60; color: #fff; }
.wplace-btn-upload { background: #8e44ad; color: #fff; }
.wplace-btn-file { background: #f39c12; color: #fff; }
...
.status-success { background: rgba(0,255,0,0.1); color: #2ecc71; box-shadow: 0 0 10px #2ecc71; }
.status-error { background: rgba(255,0,0,0.1); color: #e74c3c; box-shadow: 0 0 10px #e74c3c; }
.status-warning { background: rgba(255,165,0,0.1); color: #f39c12; box-shadow: 0 0 10px #f39c12; }
...
.wplace-stat-value { font-weight: 600; color: #775ce3; }
